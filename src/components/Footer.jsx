        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div>
            ...
            <p className='text-gray-400'>
              Empowering your technical growth. Providing a platform to all
          ...
          <div>
            ...
            <div className='flex space-x-6'>
              <a
                href='https://www.linkedin.com/company/knowhow-kjsit/'
              ...
              <a
                href='https://www.instagram.com/knowhow_tech/'
                className='hover:text-gray-400'
                target='_blank'
              >
            ...
            <div className='mt-6'>
              ...
              <a
                href='https://chat.whatsapp.com/DFGAlgy8z3TLAWIUNoltVZ'
                className='flex items-center border-2 border-green-600 text-green-600 rounded-full px-3 py-2 text-sm hover:border-white hover:text-white transition-colors duration-200 w-44'
              >
